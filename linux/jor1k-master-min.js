...
LinuxTerm.prototype.Init = function(jor1kGUI, tty) {
    ...
    var height = Math.floor(document.body.clientHeight / 16);
    var width = Math.floor(document.body.clientWidth / 8.5);
    console.log(width);
    this.term = new Terminal(height, width, this.termElementId);
